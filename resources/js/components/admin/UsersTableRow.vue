<template>
    ...
    <tr>
      ...
      <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <div class="flex items-center text-slate-800">
          ...
          <div class="font-medium text-sky-500">{{ user.name }}</div>
        </div>
      </td>
      <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <div>{{ user.email }}</div>
          ...
          >
            <div class="whitespace-nowrap">
              ...
              >
                <template #text>
                  <span
                    class="far fa-paper fa-fw fa-sm fa-regular fa-envelope"
                  />
                </template>
              </AppButton>
              <AppButton
  ...
  <!--  <tr class="bg-white-100 text-gray-900 dark:bg-white-700 dark:text-gray-100">-->
...
export default {
  ...
  methods: {
    ...
    triggerEditUser() {
      console.log('triggerEditUser', this.user);
