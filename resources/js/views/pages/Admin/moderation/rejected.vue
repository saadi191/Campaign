      ...
      >
        ...
        >
          <div class="flex items-center justify-between mb-4">
            ...
            >
              Rejected by: {{ participant.moderator_rejected.name }}
            </a>
          </div>
          <div class="flow-root">
            <ul
...
export default {
  ...
  watch: {
    search: function () {
      ...
      axios
        .post('/api/admin/moderation/rejected?search=' + this.search)
        .then((result) => {
  ...
  methods: {
    fetchParticipants() {
      ...
      if (this.search !== '') {
        axios
          .post(
            '/api/admin/moderation/rejected?page=' +
